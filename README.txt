...
MST's will be calculated by two main algorithms:
...
3. Later, the user will enter one arc which must be removed from the graph, and if the arc
   Belonged to the MST found with kruskal, It will find a new MST without it.
